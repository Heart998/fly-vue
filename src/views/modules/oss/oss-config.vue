  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <template v-else-if="dataForm.type === 4">
        <el-form-item prop="localDomain" label="域名">
          <el-input v-model="dataForm.localDomain" placeholder="绑定的域名"></el-input>
        </el-form-item>
        <el-form-item prop="localPrefix" label="路径前缀">
          <el-input v-model="dataForm.localPrefix" placeholder="不设置默认为空"></el-input>
        </el-form-item>
        <el-form-item prop="localPath" label="存储目录">
          <el-input v-model="dataForm.localPath" placeholder="如：D:/upload"></el-input>
        </el-form-item>
      </template>
    </el-form>
