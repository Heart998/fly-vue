  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-sys__dict">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        <el-form-item>
          <el-input v-model="dataForm.dictName" placeholder="字典名称" clearable @clear="getDataList()"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input v-model="dataForm.dictType" placeholder="字典类型" clearable @clear="getDataList()"></el-input>
        </el-form-item>
        <el-form-item>
  ...
  data () {
    return {
      mixinViewModuleOptions: {
        ...
        deleteURL: '/sys/dict/type/delete',
        deleteIsBatch: true
      },
      dataForm: {
        id: '0',
