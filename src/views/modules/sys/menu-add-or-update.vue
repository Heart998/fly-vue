  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="90px">
      ...
      <el-form-item label="上级菜单" prop="parentId">
        ...
        <el-input v-if="false" v-model="dataForm.parentName" v-popover:menuListPopover :readonly="true" placeholder="点击选择上级菜单" class="menu-list__input"></el-input>
      </el-form-item>
        ...
        <el-row>
          ...
          <el-col :span="2" class="icon-list__tips">
            <el-tooltip placement="top" effect="light">
              <div slot="content">全站推荐使用SVG Sprite, 详细请参考:<a href="//github.com/daxiongYang/chinalife-linkman-vue/blob/master/src/icons/index.js" target="_blank">icons/index.js</a>描述</div>
