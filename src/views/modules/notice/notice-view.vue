<template>
  <el-card shadow="never" class="aui-card--fill">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%;">
          <el-table-column prop="receiverName" label="接收者" header-align="center" align="center"></el-table-column>
          <el-table-column prop="readStatus" label="阅读状态" header-align="center" align="center">
              <template slot-scope="scope">
                  <el-tag v-if="scope.row.readStatus === 0" size="small" type="danger">未读</el-tag>
                  <el-tag v-else size="small" type="success">已读</el-tag>
              </template>
          </el-table-column>
          <el-table-column prop="readDate" label="阅读时间" header-align="center" align="center"></el-table-column>
      </el-table>
      <el-pagination
              :current-page="page"
