    ...
    <el-form :inline="true" :model="dataForm" label-width="70px">
      ...
      <el-form-item label="任务分类" v-show="dataForm.target === '1'">
        <el-select v-model="dataForm.classify" clearable style="width:240px">
          <el-option
            v-for="(item , index) in taskClassificationArr"
      ...
      <el-form-item label="任务分类" v-show="dataForm.target === '2'">
        <el-select v-model="dataForm.classify" clearable style="width:240px">
          <el-option
            v-for="(item , index) in contactPersonArr"
            :label="item.dictLabel"
            :value="item.dictValue"
            :key="index"
          ></el-option>
      ...
      <el-form-item>
        <el-button v-if="isAuth('biz:task:staffList')" @click="getDataList(1)" type="primary">查询</el-button>
...
<script>
import { getDataList } from '@/api/task-processing'
        ...
        operates: {
          ...
          list: [
            ...
            },
            {
              ...
              method: (index, row) => {
                this.taskProcessing(row, 'staging')
              }
            },
            {
              label: '修改',
