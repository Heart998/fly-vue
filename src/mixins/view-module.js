  ...
  methods: {
    ...
    deleteHandle (id) {
      ...
      this.$confirm('确定进行删除操作?', '提示', {
        ...
        let deleteURL = this.mixinViewModuleOptions.deleteURL + (this.mixinViewModuleOptions.deleteIsBatch ? '' : '/' + id)
        let params = this.mixinViewModuleOptions.deleteIsBatch ? ids : {}
        // 批量删除
        this.$http({
          url: this.$http.adornUrl(deleteURL),
          method: 'post',
